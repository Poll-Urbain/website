...
//let user2 = new User(userName, userAddress);
...
// Dynamically load images into the container
    ...
    images.forEach(image => {
        ...
        var site = getSite(image);
        //let vote = new Vote(site, user2, "Chaleur");
        //console.log(vote);
        //document.getElementById("chaleur"+image).value
        scoreDiv1.innerHTML = "Score de ce vote: " + 4*(3-i)//vote.computeVoteValue(1, i);
        scoreDiv2.innerHTML = "Score de ce vote: " + 3*(3-i);
        scoreDiv3.innerHTML = "Score de ce vote: " + 2*(3-i);
